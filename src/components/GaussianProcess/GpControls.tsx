    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
      ...
      {hasPoints && (
        <button
          ...
          className="mt-4 flex items-center justify-center px-2 py-1 bg-gray-500 text-white text-xs rounded-md hover:bg-gray-600 transition duration-200 shadow-md"
          style={{ minWidth: '90px', maxWidth: '90px', height: '28px' }}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="mb-4">
          ...
          />
        </div>          <div className="flex gap-3 mb-6">
          <button
            onClick={onGenerateSamples}
            className="flex items-center justify-center px-2 py-1 bg-purple-600 text-white text-xs rounded-md hover:bg-purple-700 transition duration-200 shadow-md"
            style={{ minWidth: '120px', maxWidth: '120px', height: '28px' }}
          >
          ...
          <button
            ...
            className={`flex items-center justify-center px-2 py-1 text-xs ${animating ? 'bg-red-500 hover:bg-red-600' : 'bg-green-500 hover:bg-green-600'} text-white rounded-md transition duration-200 shadow-md`}
            style={{ minWidth: '120px', maxWidth: '120px', height: '28px' }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              {animating ? (
        ...
        <div className="p-4 border rounded bg-gray-50">
          ...
          {/* Function Selection */}
          <div className="mb-4">
            <label className="block text-sm font-medium mb-2">Function Selection:</label>
